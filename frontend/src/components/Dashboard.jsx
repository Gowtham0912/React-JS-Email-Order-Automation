    ...
    return (
        <div className="bg-[#fdca5e] font-sans h-screen flex flex-col overflow-hidden">
            ...
            <div className="flex-1 min-h-0 flex flex-col max-w-[95%] w-full mx-auto">
                {/* KPI CARDS */}
                <div className="shrink-0 grid grid-cols-2 md:grid-cols-5 gap-3 mt-2">
                ...
                <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                ...
                <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 mb-2">
